            ...
            <html lang="en">
                ...
                <body style="margin:0;padding:0;background:#f8fafc;font-family:Arial,sans-serif;color:#0f172a;">
                    <div style="max-width:600px;margin:0 auto;padding:48px 20px;">
                        <div style="background:#ffffff;border:1px solid #e2e8f0;border-radius:16px;padding:40px;">
                            ...
                            <p style="font-size:16px;line-height:1.6;color:#475569;">
                                Welcome to Miyor. Please verify your email address
                            ...
                            <div style="margin:32px 0;">
                                <a
                                    ...
                                    style="display:inline-block;background:#0f172a;color:#ffffff;text-decoration:none;padding:14px 24px;border-radius:10px;font-weight:600;"
                                >
                                    Verify my email
                                </a>
                            </div>
                            ...
                            <p style="font-size:13px;color:#94a3b8;">
                                If you didn't create a Miyor account, you can safely
                                ignore this email.
                            </p>
                        </div>
                    </div>
